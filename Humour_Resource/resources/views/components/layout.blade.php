...
<body class="font-sans antialiased text-gray-800 bg-white overflow-x-hidden" x-data="{ mobileMenuOpen: false }">
    ...
    <!-- WhatsApp FAB -->
    <a href="https://wa.me/254700123456" target="_blank" class="fixed bottom-8 right-8 z-50 group">
        <span class="absolute right-20 top-4 bg-white text-navy-900 text-xs font-bold px-4 py-2 rounded-full shadow-xl opacity-0 group-hover:opacity-100 transition-all duration-300 whitespace-nowrap translate-x-4 group-hover:translate-x-0">
            Chat with us
        </span>
        <div class="bg-[#25D366] w-16 h-16 rounded-full flex items-center justify-center shadow-[0_10px_25px_rgba(37,211,102,0.4)] hover:scale-110 transition-all duration-300 animate-pulse-slow">
            <svg class="w-10 h-10 text-white" fill="currentColor" viewBox="0 0 24 24">
                <path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.353-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.148-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.13.57-.072 1.758-.47 2.005-.924.248-.454.248-.842.174-1.016-.074-.174-.272-.272-.57-.421zM12.012 2.903c-4.96 0-9 4.04-9 9 0 1.58.43 3.12 1.24 4.47L3 21.116l5.359-1.405c1.3.71 2.77 1.09 4.28 1.09 4.96 0 9-4.04 9-9s-4.04-9-9-9zm0 16.5c-1.37 0-2.71-.37-3.85-1.07l-.27-.17-3.17.83.85-3.1-.19-.3c-.77-1.22-1.18-2.63-1.18-4.09 0-4.14 3.36-7.5 7.5-7.5s7.5 3.36 7.5 7.5-3.36 7.5-7.5 7.5z"/>
            </svg>
        </div>
    </a>
